...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Aucun enregistrement dana la table"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précèdent"},sEmptyTable:"Aucun enregistrement dans la table",sInfo:"  Visualisation de _START_ à _END_ d'un total de _TOTAL_ enregistrements",sInfoEmpty:"Visualisation de 0 à 0 de 0 enregistrements",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:" Nombre de lignes :  _MENU_ ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrement trouvé"},oSearch:h.extend({},
